/**
 * Date Picker Mobile
 * @desc Date Picker Mobile
 * @package Girnar Soft OneJs
 * @author Kapil Gupta <kapil.gupta@girnarsoft.com>
 * @created May 17, 2016
 * @version 1.0.1
 *
 * Depends:
...
/*! 
 * Date Picker Mobile (Modified by Kapil Gupta)
...
(function ($) {
    ...
    $.easing._dd_easing = function(x, t, b, c, d) {
        return -c * ((t = t / d - 1) * t * t * t - 1) + b;
    };

    var defaults = {
        animate: true,
        init_animation: "null",//currently in no use as we have removed it from css also
        // format: "m/d/Y",//only this one allowed in this
        format: "m/Y",
        lang: "en",////only this one allowed in this customised one, in origional there are options
        lock: false,
        ...
        dropWidth: 124,//new code
        dropTextWeight: 'bold'

    };

    $.fn.gsp_dp_mob = function(options) {
        ...
        return $(this).each(function() {
            ...
            if ($(this).is('input') && $(this).attr('type') == "text") {
                ...
                var _structure = '<div class="dd-w dd-init" id="dd-w-' + _dd_id + '"><div class="dd-o"></div><div class="dd-c"><div class="dd-w-c"><div class="dd-b dd-m"><div class="dd-ul"><a class="dd-n dd-n-left"><i class="fa fa-chevron-left" aria-hidden="true"></i></a><a class="dd-n dd-n-right"><i class="fa fa-chevron-right" aria-hidden="true"></i></a><ul></ul></div></div><div class="dd-b dd-y"><div class="dd-ul"><a class="dd-n dd-n-left"><i class="fa fa-chevron-left" aria-hidden="true"></i></a><a class="dd-n dd-n-right"><i class="fa fa-chevron-right" aria-hidden="true"></i></a><ul></ul></div></div><div class="dd-s-b dd-s-b-m dd-trans"><div class="dd-s-b-ul"><ul></ul></div></div><div class="dd-s-b dd-s-b-d dd-trans"><div class="dd-s-b-ul"><ul></ul></div></div><div class="dd-s-b dd-s-b-y dd-trans"><div class="dd-s-b-ul"><ul></ul></div></div><div class="dd-s-b dd-s-b-s-y dd-trans"><div class="dd-s-b-ul"><ul></ul></div></div><div class="dd-s-b-s"><i class="dd-icon-close" ></i></div><div class="dd-b dd-sub-y"><div class="dd-ul"><a class="dd-n dd-n-left"><i class="dd-icon-left" ></i></a><a class="dd-n dd-n-right"><i class="dd-icon-right" ></i></a><ul></ul></div></div><div class="dd-s"><a>Done</a></div><div class="dd-s cancel_btn"><a>Cancel</a></div></div></div></div>';
                ...
                var _dd_input = $(this),
                    ...
                    _dd_settings = $.extend(defaults, options),
                    _dd_event = null,
                ...
                var __dd_getNum = function(val, type, def){
                        if(val!=null && val!=''){
                            var l = val.toString().length;
                            if(!isNaN(val) && l > 0){
                                if(type=='y' && l===4){
                                    return val;
                                } else if(type=='m' && val<=12){
                                    return val-1;
                                } else if(type=='d' && val<=31){
                                    return val;
                                }
                            }
                        }
                    ...
                    __dd_setCurrDate = function(){
                        var _st = _dd_settings;
                        t_y_cur = __dd_getNum(_st.defaultYear, 'y', t_y_cur);
                        t_m_cur = __dd_getNum(_st.defaultMonth, 'm', t_m_cur);
                        // t_d_cur = __dd_getNum(_st.defaultDay, 'd', t_d_cur);
                    };
                //check if there is any default date params given
                __dd_setCurrDate();
...
//                        var screenHeight=$(document).height();
                        //var inputTop= _dd_input.offset().top-15;
                        //window.scrollTo(0,inputTop); 
                        //alert(drpDownTop);
                        _dd.find('.dd-c').css({
                            'top': _dd_input.offset().top + (_dd_input.innerHeight()+15),
                    ...
                    _dd_submit = function() {
                        ...
                        if (_dd_settings.lock) {
                            ...
                            var
                                ...
                                d1 = Date.parse(t_y_cur + "-" + (t_m_cur + 1)) / 1000,
                                d2 = Date.parse(_dd_y + "-" + _dd_m ) / 1000;

                            if (_dd_settings.lock == 'today') {
                                if (d2 < d1) {
                                    _dd_alert();
                                    return false;
                                }
                    ...
                    _dd_construct = function() {
                        ...
                        _dd_el.find('.dd-s').click(function() {
                ...
                _dd_input.click(function() {
                    //Scroll to top on click of input box
                    var inputTop= _dd_input.offset().top-15;
                    window.scrollTo(0,inputTop); 
